...
_See code: [src/commands/init.ts](https://github.com/cloudgraphdev/cli/blob/v0.20.10/src/commands/init.ts)_
...
_See code: [src/commands/teardown.ts](https://github.com/cloudgraphdev/cli/blob/v0.20.10/src/commands/teardown.ts)_
