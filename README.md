...
3. Scan for cloud infrastructure for all configured providers. This command will reach out and read all of the metadata on your cloud infrastructure. Note that it is **completely normal** to see warnings and errors while the `cg scan` command runs, these are usually caused by permissions issues. That said, if you encounter any problematic errors running CloudGraph you can prepend `CG_DEBUG=5` to the beginning of your command as in, `CG_DEBUG=5 cg scan`. This will print out the verbose logs with more information and save the output to `debug.log`. Please share your logs with us either by opening an [issue on GitHub](https://github.com/cloudgraphdev/cli/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc) or let us know in our [Slack Workspace](https://join.slack.com/t/cloudgraph-workspace/shared_invite/zt-vb8whl6u-3YH0F4mHXNyC6SOqZJvClQ).
...
_See code: [src/commands/init.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/init.ts)_
...
_See code: [src/commands/launch.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/launch.ts)_
...
_See code: [src/commands/load.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/load.ts)_
...
_See code: [src/commands/provider/index.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/provider/index.ts)_
...
_See code: [src/commands/provider/add.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/provider/add.ts)_
...
_See code: [src/commands/provider/install.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/provider/install.ts)_
...
_See code: [src/commands/provider/list.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/provider/list.ts)_
...
_See code: [src/commands/provider/remove.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/provider/remove.ts)_
...
_See code: [src/commands/provider/update.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/provider/update.ts)_
...
_See code: [src/commands/scan.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/scan.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/serve.ts)_
...
_See code: [src/commands/teardown.ts](https://github.com/cloudgraphdev/cli/blob/v0.11.0/src/commands/teardown.ts)_
<!-- commandsstop -->
